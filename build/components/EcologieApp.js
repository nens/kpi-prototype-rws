...
var debug = require('debug')('EcologieApp.js');
...
var EcologieApp = React.createClass({
    ...
    componentDidMount: function() {
        ...
        d3.csv("static/data/" + config.csvFileEcologie, function (csv) {
...
var InfoModal = React.createClass({
  render: function() {
    return this.transferPropsTo(
        <Modal title="Ecologie" animation={true}>
